      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 w-full space-y-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2.5">
          <span className="text-[10px] font-bold text-[#6B8B7B] uppercase tracking-widest bg-[#EEF4F0] px-3 py-0.5 rounded-full inline-block">
            Ritual de Renovación Cutánea
          </span>
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-[#1C1B1A] tracking-tight">
            Protocolo de <span className="text-[#6B8B7B]">Skin Cycling</span>
          </h1>
          <p className="text-xs sm:text-sm text-[#66615C] leading-relaxed max-w-xl mx-auto">
            Metodología dermatológica de noches alternas para obtener los máximos beneficios de exfoliantes y retinoides protegiendo la barrera de tu piel.
          </p>
        </div>
